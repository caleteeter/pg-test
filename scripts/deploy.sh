...
# create users
psql -U $administratorLogin -P  "postgres://$administratorLogin@$serverName:$administratorLoginPassword@$serverName.postgres.database.azure.com:5432/postgres" -c "CREATE DATABASE northwind;"
